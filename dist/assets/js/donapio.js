...
//SVG   .no-svg
//Touch Events   .no-touchevents
//Flexbox   .no-flexbox
//CSS Transforms   .no-csstransforms
//html5shiv
...
/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-csstransforms-flexbox-svg-touchevents-setclasses-shiv-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
jQuery(document).ready(function($){
    ...
    $.fn.openclick = function (options) {
        ...
        var settings = $.extend({
            ...
            trackFocus: false, //закрывать при потере фокуса
            open: function () {
            },
            close: function () {
            },
        ...
        return this.each(function () {
            ...
            link.on('click', function (e) {
                ...
                obj.slideToggle('normal', function () {
                    if (obj.is(':hidden')) { //только что закрылось
                        ...
                        if(settings.trackFocus){
                            $d.on('click', function(e){
                                if ( ($(e.target).closest(obj).length) || ($(e.target).closest(link).length)) return;
                                obj.slideUp();
                                e.stopPropagation();

                                settings.lostfocus.call(link);
                            });
                        }
    ...
    /*--- HINTS ---*/
    $.fn.hint = function (method, options) {

        var settings = $.extend({
            hinttext: '',
            hintactiveclass: 'hint-active',
            hintduration: 3000
        }, options);
            ...
            init: function(options){
                return this.each(function () {
                    ...
                    if(settings.hinttext != '')
                        $hintlink.attr('data-hint', settings.hinttext);

                    if(!$hintlink.hasClass(settings.hintactiveclass)){
                        $hintlink.addClass(settings.hintactiveclass);

                        setTimeout(function(){
                          $hintlink.removeClass(settings.hintactiveclass);
        ...
        if ( methods[method] ) {
            ...
            $.error( 'Метод с именем ' + method + ' не существует для jQuery.hint' );
        } 
    };
 ...
 //        }
    ...
    if ($('.js-showBlock').length > 0) {
        $('.js-showBlock').openclick({
            el_toggle: 'href',
            trackFocus: true,
            open: function () {
                $(this).addClass('active');
    ...
    /*---  ACTIONS IN HEADER ---*/
    $('#header-search_close').on('click',function(e){
        e.preventDefault();
        e.stopPropagation();
    ...
    $('#header-i_menu').on('click', function(){
    ...
    $('#header-mobilePannel_hide').on('click', function(){
        $header.removeClass('mobileOn');
    });
